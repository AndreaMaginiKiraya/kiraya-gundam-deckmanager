# Gundam Card Game — Comprehensive Rules (Ver. 1.8.0, updated 2026-06-12)

Gundam Card Game Comprehensive Rules Ver. 1.8.0 Updated Jun 12, 2026 Table of Contents 1. Game Overview 2. Card Information 3. Card Types 4. Game Locations 5. Essential Game Terminology 6. Preparing to Play 7. Game Progression 8. Attacking and Battles 9. Action Steps 10. Effect Activation and Resolution 11. Rules Management 12. Multiplayer Battle 13. Keyword Effects and Keywords Comprehensive Rules
...
1-3-2-1. If you are required to put an entity into some state that entity is already in, the entity remains in the state it was in, and the action putting it into that state is not performed. Ex: If you are instructed to rest a Unit that is currently rested, since the Unit is already rested, it is not rested again.
...
6-2-1-1. Present the deck and resource deck you will use in the game. The deck and resource deck must conform to the rules on deck construction explained in

6-1. 6-2-1-2. Each player thoroughly shuffles their deck. When finished, each player places their deck face down in their deck area.
...
10-3-3. When a Command card is played or a triggered effect is triggered and its effect instructs you to “choose (something)” or “you may choose (something),” those ta rgets are chosen at the point in time when the instructions appear in the effect.
...
13-1-5-4. <First Strike> is applied even when performing the effect "Begin a battle between this Unit and it and only perform the damage step."
...
13-1-8-1. The <Development> keyword effect is typically contained within a keyword for a timed effect, such as 【Deploy】 or 【When Linked】, and can be activated at that time. For example: 【 Deploy
・ Development (number) 】 means "When deployed, you may exile (number) of (G Generation) cards in your trash from the game. If you do, activate the following effect."
...
13-2-10-2. 【During Pair 】 can appear as “ 【During Pair ･(qualifications)】 (text).” This means while a Pilot fulfilling the (qualifications) is paired with this Unit, perform (text). Ex: An effect reading “ 【During Pair･(Earth Federation) Pilot 】【Attack】 Draw 1” lets you draw a card when the Unit attacks if an (Earth Federation) Pilot is paired with it.
...
●Ver.1.8.0  (Jun 12, 2026) Update
・3-4-6-3-1, 5-22,

13-1-5-4. Added

●Ver. 1.7.0  (May 22, 2026) Update
・13-1-8. Added

●Ver. 1.6.0  (April 9, 2026) Update
・5-21. Added
・6-2-1-4 Revised, 6-2-1-4-1 Added

●Ver. 1.5.0  (January 9, 2026) Update
・5-17-4. Added
・2-11-3,
...
13-2-12-1. Corrected language to conform to actual usage
...
・5-20. Added
・10-1-6-8-1. Added
・7-5-3-1, 7-5-4-1, 8-5-3-2-2, 12-2, 13-1-5-2,

13-2-10-2. Corrected errors
...
10-1-6-1. Revised 【Attack】 keywords.

● Ver. 1.1.0 (July 24, 2025) Update
・13-2-11,

13-2-12. Added (【When Linked】【During Link】 keywords)
